...
export default function WhatsappButton() {
  ...
  return (
    <Link
      ...
      target="_blank"
      className="heartbeat fixed bottom-6 right-6 bg-green-500 p-1.5 hover:bg-green-600 text-white rounded-xl  z-50 transition-all flex items-center justify-center"
    >
      <FaWhatsapp size={30} />
